...
export const OCCUPATIONS: Occupation[] = [
  ...
  // Добавлен 17.08.2026 при разборе судьбы 5 старых вакансий "Målare"
  // (маляр — попали в базу ещё по списку категорий до dead0aa/14.08.2026,
  // formально сейчас ни под одним термином, отсюда и вопрос). Не
  // regionRestricted, как byggnadsarbetare-замена ниже: региональный сигнал
  // слабый (1 в Norrbotten, 0 в Västerbotten из 140 по всей Швеции —
  // не лучше убранного byggnadsarbetare), но по содержанию — обычная
  // строительная специальность, не care: на выборке 40 объявлений
  // упоминание kollektivavtal — 11 (27.5%, в норме сегмента), явное жильё —
  // 0 (как и у большинства строительных терминов, редкость, не признак
  // несовместимости), концентрация по регионам ровная (Stockholm/Skåne/
  // Västra Götaland), не северная. Держим как общий термин — как
  // lagerarbetare/chaufför/svetsare/elektriker/montör выше — не как
  // северный.
  {
    term: "målare",
    labels: {
